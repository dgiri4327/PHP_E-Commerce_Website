		...
		function F(a, b, d, e) {
			...
			return (
				a.split(" ").forEach(function (a) {
					b.addEventListener(a, f, !!qa && { passive: !0 }),
						g.push([a, f]);
				}),
				g
			);
		...
		function L(a, b) {
			b.handle && (n(b.handle, c.cssClasses.active), (ua -= 1)),
				...
				0 === ua &&
					...
					a.cursor &&
						((Aa.style.cursor = ""),
						Aa.removeEventListener("selectstart", d))),
					...
					la.forEach(function (b, d) {
						if (!1 !== b && 0 !== d && d !== la.length - 1) {
							...
							m(b, c.cssClasses.draggable),
								a.fixed &&
									(g.push(e.children[0]), g.push(f.children[0])),
