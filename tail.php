						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									...
									<p>E-shop's infrastructure is manipulate with MVC Pattern and it's developed in a Raw PHP project. </p>
									<p> 
										<li> HTML5, CSS3 </li>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>Bihar, Gopalganj, India</li>
										<li><span class="contact-info-label">Phone:</span>Toll Free <a href="tel:">(+91) 748-830-4880</a></li>
										<li><span class="contact-info-label">Email:</span> <a href="mailto:mail@example.com">dgiri4327@gmail.com</a></li>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | Developed By 
							<a href="//aamroni.info" target="_blank"> Deepak Kumar Giri</a>
						</p>
				...
				<div class="modal-content">
					<div class="cuspop" style="background-image: url('public/assets/images/menu-bg.png')">
						...
						<div class="modal-body">
							...
							<p>Subscribe to the <b> E-Shop Online Shopping</b>  newsletter <br/> to receive timely updates from your favorite products.</p>
							<form action="" method="post">
								<div class="row">
